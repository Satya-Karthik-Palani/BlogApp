    ...
    <>
        <div className='flex justify-between my-10 mx-60 min-h-screen'>
            ...
            <div className='flex flex-col gap-y-2 w-1/3 bg-gray-300 rounded-lg p-4  text-black h-96 dark:bg-[#2f3335] dark:text-white'>
                ...
                <input onChange={(e)=>setTitle(e.target.value)} defaultValue={post.title} placeholder='Title of the Blog' type='text' className='m-2 p-3 border border-black rounded-lg dark:bg-[#3b3b3b]'/>
                <textarea onChange={(e)=>setDescription(e.target.value)} defaultValue={post.description} placeholder='Description about the blog' type="text" className='m-2 p-3 border border-black rounded-lg dark:bg-[#3b3b3b]'/>
